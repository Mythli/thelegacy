...
* $structure = Sys_Mail_RFC822::parseAddressList($address_string, 'example.com', TRUE)
* print_r($structure);
*/

class Sys_Mail_RFC822
{
    /**
    ...
    */
     ...
     * 
     * @return object Sys_Mail_RFC822 A new Sys_Mail_RFC822 object.
     */
    ...
    function parseAddressList($address = null, $default_domain = null, $nest_groups = null, $validate = null, $limit = null)
    {
        ...
        if (!isset($this->mailRFC822)) {
            $obj = new Sys_Mail_RFC822($address, $default_domain, $nest_groups, $validate, $limit);
