...
function SetStateImage(state, target) {
    switch (state) {
        ...
        case "error":
            $(target+"_val").css("background-image", "url('img/input_error_bg.png')");
            $(target+"_val").css("display", "block");
            $(target+"_val_ico").attr("src", "img/error.png");
        break;
        case "success":
            $(target+"_val").css("background-image", "url('img/input_success_bg.png')");
            $(target+"_val").css("display", "block");
            $(target+"_val_ico").attr("src", "img/success.png");
        break;
        case "load":
            $(target+"_val").css("display", "block");
            $(target+"_val_ico").attr("src", "img/ajaxLoad.gif");
        break;
        default:
...
$(document).ready(function(){
    ...
    $("#headIMG").attr("src","img/screenshots/panorama/"+gTopBgs[gTopbgId]+"");
